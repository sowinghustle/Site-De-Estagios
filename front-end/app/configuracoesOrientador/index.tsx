...
export default function ConfiguracoesAluno() {
  ...
  const [usuario, setUsuario] = useState("Orientador Cleberiano");
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <CustomContainer title="Informações Institucionais">
          ...
          <CustomInput label="Matricula do colaborador " placeholder="0000000000000" onChangeText={setNome} />
          <CustomInput label="Nome da institução" placeholder="Digite o nome da instituição" onChangeText={setRG} />
          <CustomInput label="Cargo na institução" placeholder="Digite o seu cargo" onChangeText={setTelefone} />
          <br />
